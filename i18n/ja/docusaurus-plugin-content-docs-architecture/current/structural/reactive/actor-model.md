...
- **[Event Loop ベース構造](./event-loop.md)**：イベントドリブンという点で近いが、モデルは異なる
- **[Reactive Streams](./reactive-streams.md)**：イベントストリーム処理のための標準
- **[EDA（Event-Driven Architecture）](../../integration/event-driven.md)**：システム全体のイベント駆動構造
