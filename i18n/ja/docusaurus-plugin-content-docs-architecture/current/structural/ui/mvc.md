...
今日の Web / モバイル開発では、
MVC の発想をベースにしたより洗練されたスタイル（[MVP](./mvu.md) / [MVVM](./mvvm.md) / [MVU](./mvu.md)）が採用されることが多くなっている。

## ✅ 歴史（系譜・親スタイル）

- 1970〜80 年代の Smalltalk から生まれた GUI アプリケーション向けパターン
- 多くのフレームワーク（Rails, ASP.NET MVC など）の思想的ベース
- [MVP](./mvu.md) / [MVVM](./mvvm.md) / [MVU](./mvu.md) など後継スタイルの“祖先”

## ✅ 関連スタイル

- **[MVP](./mvp.md)**：Presenter に画面ロジックを集約した発展系
- **[MVVM](./mvvm.md)**：データバインディングを前提としたモダンな UI パターン
- **[MVU](./mvu.md)**：関数型の発想で状態と更新を扱うスタイル
