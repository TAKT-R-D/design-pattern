...
- **[Active Record](./active-record.md)**：行単位の操作に強い
- **[Anemic Domain Model](./anemic-domain-model.md)**：データ中心の文脈でよく併発
- **Repository パターン**：DDD の集合操作。思想は異なるが関係性は深い
- **[CQRS](../../data/cqrs.md) の Read Model**：Table Module 的な“ビュー用集合処理”が登場する
