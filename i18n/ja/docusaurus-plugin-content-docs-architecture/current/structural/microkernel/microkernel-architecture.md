...
- [Plugin Architecture](./plugin-architecture.md) という名前でも文脈によっては同義的に扱われることがある

## ✅ 関連スタイル

- **[Plugin Architecture](./plugin-architecture.md)**：よりアプリケーション寄りのプラグイン構造
- **[Layered Architecture](../layered/index.md)**：コアがインフラストラクチャレイヤの一部として実装されることも
- **[Microservices](../../topologies/microservices.md)**：機能分割のアプローチとしては別系統だが、拡張性というゴールは共有
