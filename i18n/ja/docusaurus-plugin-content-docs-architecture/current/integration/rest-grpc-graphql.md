...
- **[Event-driven / Messaging](./event-driven.md)**：非同期統合スタイルとの対比
- **[API Gateway / BFF](./api-gateway-bff.md)**：これらの API をどう公開・集約するかのスタイル
- **[Service Mesh](./service-mesh.md)**：通信経路の制御・観測の観点からの補完的スタイル
