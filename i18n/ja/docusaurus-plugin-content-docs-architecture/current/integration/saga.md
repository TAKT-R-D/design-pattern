...
- [EDA](./event-driven.md) / [CQRS](../data/cqrs.md) / [Event Sourcing](../data/event-sourcing.md) などと組み合わせて使われることも多い

## ✅ 関連スタイル

- **[Event-driven Architecture](./event-driven.md)**：コレオグラフィ型 Saga は EDA 上に構築される
- **[REST / gRPC](./rest-grpc-graphql.md)**：オーケストレーション型でのステップ呼び出しに使われる
- **[CQRS](../data/cqrs.md) / [Event Sourcing](../data/event-sourcing.md)**：状態遷移の追跡や補償ロジックの実装と相性が良い
