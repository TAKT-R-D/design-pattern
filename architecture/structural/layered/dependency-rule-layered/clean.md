...
Clean Architecture もフレームワークから独立した考え方ですが、実際には次のような技術スタックで多く実践されています。
...
というモダンアーキテクチャの key idea を、
シンプルな図とルールセットにまとめたスタイルです。

「完璧に守る」ことよりも、
**「依存を内向きに保つ」という原則をチームで共有するための共通言語** として使うのが現実的です。
