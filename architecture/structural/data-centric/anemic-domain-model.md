...
## 8. Framework Examples（代表的に発生しやすい文脈）
...
## 9. Supported Design Patterns（このスタイルを補助するデザインパターン）
...
「分かりやすい」「実装しやすい」という理由で採用されがちですが、  
**複雑なドメインには決して向かず、構造の崩壊を加速させる危険があります。**
