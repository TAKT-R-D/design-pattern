...
高速性・学習コストの低さは非常に大きな強みです。

---

## 5. 不向きなケース

次のようなアプリでは Active Record は破綻しやすいです：
...
もし複雑性の兆候が見え始めたら、  
Domain Model・Layered・Hexagonal などへの移行を検討すべきです。
