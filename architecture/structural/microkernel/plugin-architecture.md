...
Plugin Architecture はアプリケーションレベルでの Microkernel 的構造として広く普及しています。
...
Plugin Architecture は、Microkernel と比べるとアプリケーション寄りだが、用いられるパターンの本質は同じです。
