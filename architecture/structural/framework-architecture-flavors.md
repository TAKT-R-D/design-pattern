...
## 1. はじめに：フレームワークはアーキテクチャではない

多くのフレームワークは、**特定のアーキテクチャスタイルを強制するわけではありません**。  
しかし、それぞれに **「こう設計すると自然にしっくりくる」傾向（flavor）** が存在します。
...
## 3. Data-centric 系フレームワークのアーキテクチャ風味
...
## 4. Layered / Clean / Dependency Rule 系フレームワーク
