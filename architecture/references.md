...
- **Patterns of Enterprise Application Architecture** (Martin Fowler)
  ...
  - [Official Catalog (martinfowler.com) <IconExternalLink />](https://martinfowler.com/eaaCatalog/)
...
- **Enterprise Integration Patterns** (Gregor Hohpe, Bobby Woolf)
  ...
  - [Official Catalog (enterpriseintegrationpatterns.com) <IconExternalLink />](https://www.enterpriseintegrationpatterns.com/)
